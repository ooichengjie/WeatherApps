...
const getData = async () => {
 ...
 useEffect(() => {
  ...
  return (
    <div className="App">
      <div className='card'>
        <h2 className='="title'><i className="fa fa-cloud"></i>Weather Application</h2>
        <div className='search-form'>
          <input type="text" onChange={(e) => setCity(e.target.value)} placeholder='Enter the city'/>
        ...
        {weatherdata !== null ? (
                  ...
                  <div className="temperature-range">
                   ...
                   || Max: {parseFloat(weatherdata.main.temp_max - 273.16).toFixed(1)}&deg; 
